difference () {
  union () {
    ...
    union () {
      union () {
        translate ([-15, -10, 5]) {
          translate ([-46.655201581408875, -34.58758093443082, 21.923397489335425]) {
    ...
    difference () {
      union () {
        ...
        union () {
          ...
          translate ([-24.6266031238187, 37.23835395935926, 2.65]) {
            union () {
              cylinder (h=5.3, r1=4.255, r2=4.15, center=true);
              translate ([0, 0, 2.65]) {
                sphere (r=4.15);
          ...
          translate ([12.385464659042938, -10.669221241834453, 2.65]) {
            union () {
              cylinder (h=5.3, r1=4.255, r2=4.15, center=true);
              translate ([0, 0, 2.65]) {
                sphere (r=4.15);
        ...
        union () {
          difference () {
            translate ([-96.98068019647579, 24.57369936815289, -9.571862280374784]) {
              cube ([6, 12, 12], center=true);
            }
            translate ([-97.98068019647579, 23.57369936815289, -9.571862280374784]) {
              cube ([4, 10, 12], center=true);
            }
          }
          translate ([-62.10477475247521, 37.56523908477192, 2]) {
            cube ([19, 12, 4], center=true);
          }
          union () {
            translate ([-75.7047747524752, 37.56523908477192, 2]) {
      ...
      union () {
        ...
        translate ([-24.6266031238187, 37.23835395935926, 1.9]) {
          union () {
            cylinder (h=3.8, r1=2.655, r2=2.55, center=true);
            translate ([0, 0, 1.9]) {
              sphere (r=2.55);
        ...
        translate ([12.385464659042938, -10.669221241834453, 1.9]) {
          union () {
            cylinder (h=3.8, r1=2.655, r2=2.55, center=true);
            translate ([0, 0, 1.9]) {
              sphere (r=2.55);
      ...
      union () {
        union () {
          translate ([-75.7047747524752, 43.56523908477192, 5]) {
            rotate (a=90.0, v=[1, 0, 0]) {
              cylinder ($fn=30, h=40, r=2.55, center=true);
            }
          }
          translate ([-75.7047747524752, 36.56523908477192, 5]) {
            cube ([6.2, 11, 6], center=true);
          }
        }
        translate ([-62.10477475247521, 34.56523908477192, 3]) {
          cube ([15, 12, 2], center=true);
        }
        translate ([-62.10477475247521, 47.56523908477192, 5]) {
          cube ([8.1, 40, 3.1], center=true);
        }
      }
    }
  }
