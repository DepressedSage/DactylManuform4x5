difference () {
  union () {
    ...
    union () {
      union () {
        translate ([-15, -10, 5]) {
          translate ([-46.239378199773356, -34.621722993398144, 19.579394785252042]) {
    ...
    difference () {
      union () {
        ...
        union () {
          difference () {
            translate ([-96.56485681484028, 24.53955730918557, -7.615865032141883]) {
              cube ([6, 12, 12], center=true);
            }
            translate ([-97.56485681484028, 23.53955730918557, -7.615865032141883]) {
              cube ([4, 10, 12], center=true);
            }
          }
          translate ([-61.68895137083969, 37.5310970258046, 2]) {
            cube ([19, 12, 4], center=true);
          }
          union () {
            translate ([-75.28895137083968, 37.5310970258046, 2]) {
