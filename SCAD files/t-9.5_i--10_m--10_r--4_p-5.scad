difference () {
  union () {
    ...
    union () {
      union () {
        translate ([-15, -10, 5]) {
          translate ([-46.655201581408875, -34.58758093443082, 25.423397489335425]) {
    ...
    difference () {
      union () {
        ...
        union () {
          ...
          translate ([13.632934803949492, -12.771342809049196, 2.65]) {
            union () {
              cylinder (h=5.3, r1=4.255, r2=4.15, center=true);
              translate ([0, 0, 2.65]) {
                sphere (r=4.15);
      ...
      union () {
        ...
        translate ([-24.002868051365425, 40.18668395637745, 1.9]) {
          union () {
            cylinder (h=3.8, r1=2.655, r2=2.55, center=true);
            translate ([0, 0, 1.9]) {
              sphere (r=2.55);
        ...
        translate ([13.632934803949492, -12.771342809049196, 1.9]) {
          union () {
            cylinder (h=3.8, r1=2.655, r2=2.55, center=true);
            translate ([0, 0, 1.9]) {
              sphere (r=2.55);
